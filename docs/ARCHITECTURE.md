...
1. Launcher wrappers:
   - `agent <tool>` resolves policy from an explicit override, tool permission controls, otherwise the container default, and validates actual conflicts before container creation
